...
public class Constants {
	...
	public final static int LANE_CHANGE_RIGHT = 0x00000001;//˵��������rules
	public final static int LANE_CHANGE_LEFT = 0x00000002;//˵��������rules
	public final static int LANE_CHANGE = 0x00000003;//˵��������rules
