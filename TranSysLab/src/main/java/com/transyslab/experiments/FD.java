...
public class FD {
	public static void main(String[] args) {
		...
		double[] ob = new double[] {0.4633, 21.7950, 0.1765, 120/3.6};
		double[] fr = new double[] {48.42777377001352,0.5259902833066845,8.940854882903562,6.885166468931501};
		...
		for (int i = 0; i < 10; i++) {
			if (i!=9)
				continue;
			mlpEngine
					.alterEngineObParas(ob)
					.alterEngineFreeParas(fr);
